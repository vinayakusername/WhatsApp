    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String verificationId,
                ...
                Toast.makeText(PhoneLoginActivity.this,"code has been Sent to You,Please check and verify....",Toast.LENGTH_SHORT).show();
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                             loadingBar.dismiss();
                             Toast.makeText(PhoneLoginActivity.this,"Conguratulation you are successfully loged in",Toast.LENGTH_SHORT).show();
